...
<main class="hero-carousel">
    <div class="hero-carousel__item active">
        <div class="container hero-carousel__text-container">
            <div class="hero-carousel__text">
                <h1>
                    GET THE <br>
                    <strong>BEST SERVICE</strong><br> IN TOWN
                </h1>
                <a class="cta-btn" href="#our-services">
                    See our services
                </a>
            </div>
        </div>
    ...
    <div class="hero-carousel__item">
        <div class="container hero-carousel__text-container">
            <div class="hero-carousel__text">
                <h1>
                    WE BRING <br>
                    <strong>UNPARELLED</strong><br> CUSTOMER SATISFACTION
                </h1>
                <a class="cta-btn" href="/register">
                    Become a member
                </a>
            </div>
        </div>
    ...
    <div class="hero-carousel__buttons">
        <button id="to-1" class="active">1</button>
