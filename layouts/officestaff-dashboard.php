...
<header class="main-header">
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li><img src="<?php echo $officestaff->image; ?>"
                     alt="<?php echo "{$officestaff->f_name} {$officestaff->l_name}'s profile photo" ?>"></li>
        </ul>
    </nav>
    <div class="main-header__actions">
        <img src="<?php echo $customer->image; ?>"
             alt="<?php echo "{$officestaff->f_name} {$officestaff->l_name}'s profile photo" ?>">
